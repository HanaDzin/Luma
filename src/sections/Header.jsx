...
const Header = () => {
  ...
  // used to customize the header component to be visible when scrolling
    ...
    >
      <div className="container flex h-14 items-center max-lg:px-5">
        <a className="lg:hidden flex-1 cursor-pointer z-2">
          <img src="Luma.png" alt="logo" width={130} height={60} />
        </a>
        <div
          className={clsx(
            "w-full max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:w-full max-lg:bg-s2 max-lg:opacity-0",
            mobileIsOpen ? "max-lg:opacity-100" : "max-lg:pointer-events-none"
          )}
        >
          <div
          ...
          >
            <nav className="max-lg:relative max-lg:z-2 max-lg:my-auto">
              <ul className="flex max-lg:block max-lg:px-12">
                ...
                <li className="nav-logo">
                  ...
                  >
                    <img src="Luma.png" width={160} height={55} alt="logo" />
                  </LinkScroll>
                </li>
                <li className="nav-li">
                  <NavLink title="faq" />
            ...
            {/* div with a background for mobile menu */}
        ...
        <button
          onClick={() => setmobileIsOpen((prevState) => !prevState)}
          className="lg:hidden z-2 size-10 border-2 border-s4/25 rounded-full flex justify-center items-center"
        >
          <img
            src={`/images/${mobileIsOpen ? "close" : "magic"}.svg`}
            alt="magic"
